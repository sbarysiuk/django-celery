...
class Migration(SchemaMigration):
    """
    have to add this migration because of the migration from django-celery 2.2.4.
    """

    def forwards(self, orm):
        db.add_column('djcelery_taskstate', 'retries', self.gf('django.db.models.fields.IntegerField')(default=0))
